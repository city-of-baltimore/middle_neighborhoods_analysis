...
<div align = "right" style="float: right; width: 40%">
...
leaflet() %>% 
  ...
  addLegend("bottomright",
            ...
            labels = c("HMT definition", "Median income definition"))
```
...
bins <- c(0, 250, 500, 750, 1000, 2000, Inf)
...
# There are drug hot spots in middle neighborhoods
...
# Narcotics 911 Calls for Service Hotspots
