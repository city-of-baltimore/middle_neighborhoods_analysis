...
mris.sale.labels <- paste0(
  ...
  mris.recent.outliers$Address,
  "<br>Sale Price in 2018: ", 
  as.character(mris.recent.outliers$Close_Price),
  "<br>Recent Renovation: ", mris.recent.outliers$Year_Renovated
)
...
julie.list.labels <- paste0(
  ...
  "<br>Sale Price in 2018: ", 
  as.character(julie.list$Close_Price),
  "<br>Recent Renovation: ", julie.list$Year_Renovated
)
...
color = iteam.colors[3],
  ...
  addCircleMarkers(data = mris.recent.outliers,
